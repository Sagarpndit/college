...
<template>
    ...
    <div class="user-pofile-card-wrapper">
        <div class="flex flex-column lg:flex-row lg:align-items-end justify-content-between p-4 gap-4">
            <div class="flex flex-column sm:flex-row sm:align-items-center gap-4">
                <!-- avatar -->
                <div class="user-pofile-card-img">
                    <img :src="userProfile.profileImage ? `${baseURL}/${userProfile.profileImage}` : '/avatar/1.jpg'" alt="Image" crossorigin="anonymous" />
                ...
                <div class="lh-1">
                    ...
                    <p class="mb-1">{{ userProfile.email || userProfile.businessEmail }}</p>
            ...
            <div class="flex flex-column sm:flex-row gap-2">
                <Button size="large" label="My Account" outlined icon="pi pi-user" @click="router.push('/user-profile')" />
            </div>
        </div>
    </div>
</template>
